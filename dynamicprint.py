...
class multiPrinter:
    ...
    def addLine(self, line, color = 'default', style = 'normal'):
...
if __name__ =="__main__":
    ...
    printer.addLine("oroszlan", 'green')
    printer.update()
    time.sleep(2)
    printer.addLine("tigris", 'blue')
    printer.addLine("marha")
    printer.addLine("kutya", 'yellow')
    printer.update()
    time.sleep(2)
    printer.addLine("macska", 'MAGENTA' , 'bright')
    printer.addLine("borju", 'green', 'dim')
    printer.update()
